...
<form action="/read/story" method="POST" >
    ...
    <div class="d-flex justify-content-center align-items-center">
        ...
        <div class="read_story_block_details">
    ...
    <div class="read_story_content_container rounded-3 p-5 mt-4">
        <p class="read_story_content">{{$story->content}}</p>
    </div>
    ...
    <div class="comment_item_container mb-3">
        {{-- Individual Comments --}}
        ...
        <form class="d-flex justify-content-between align-items-center mt-4" action="{{route('comment.add')}}" method="POST">
            @csrf
            <div class="form-group comment_input_container">
                <input type="text" name="user_id" class="form-control" value="{{auth()->user()->id}}" hidden>
                <input type="text" name="story_id" class="form-control" value="{{$story->id}}" hidden>
                <input type="text" class="comment_input form-control shadow-none bg-white border-1 px-3 py-2" name="comment" placeholder="Enter your comments here...">
            </div>
            <button class="submit_comment_button border-0" type="submit"><i class="fa fa-send submit_comment_icon"></i></button>
        </form>

          ...
          <div class="story_modal_content">
              ...
              <div id="modal_body">
                ...
                <div class="modal_account_dp_name_container d-flex">
                  <div class="modal_account_story_dp_container">
                    <img id="modal_account_dp" class="modal_story_account_dp" src="../assets/General/user_pic.jpg" >
                  </div>
                  <div class="modal_account_name_container">
                    <p id="modal_account_penname" class="modal_story_account_penname"> akotosinathoy21 </p>
                    <p class="modal_account_name_separator"> | </p>
                    <p id="modal_account_name" class="modal_story_account_name"> Nathaniel E. Ribada </p>
                  </div>
                </div>
                ...
                <div class="modal_story_header_container d-flex justify-content-between">
                  <div class="modal_story_title_genre_container">
                    <p class="modal_story_title_container"> <span class="dpurple_highlighter"> TITLE: </span><span id="modal_story_title"> Kalampag ng Papag </span> </p>

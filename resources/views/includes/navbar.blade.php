    ...
    <nav>
      <div class="nav" id="nav-tab" role="tablist">
        ...
        <div class="header_container">
          <a class="header_index_link" href="../html/admin_index.html" data-bs-toggle="tab" data-bs-target="#nav-panel" type="button" role="tab" aria-controls="nav-panel" aria-selected="true"><img class="header_logo" src="../assets/General/GCwento_purple_logo.png" alt=""></a>
        </div>
